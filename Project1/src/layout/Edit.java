...
public class Edit {
    ...
    public static void showEditStock(String nama) {
        Scanner sc = new Scanner(System.in);
        Produk produk = DbController.getProdukByNama(nama);
        ...
        System.out.println("Edit Nama");
        System.out.println("================================");
        System.out.println("Stock Awal: " + produk.getStock());
        System.out.println("--------------------------------");
        System.out.print("Stock Baru: ");
        int stockBaru = sc.nextInt();
        DbController.updateJumlah(produk.getId(), stockBaru);
